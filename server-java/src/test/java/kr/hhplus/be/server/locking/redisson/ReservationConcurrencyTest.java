...
public class ReservationConcurrencyTest {
    ...
    @DisplayName("분산락을 사용하여 하나의 좌석을 10 개의 요청이 동시에 요청할 때, 해당 좌석에 대한 예약은 1번만 수행 된다.")
    @Test
    void thread_10() throws InterruptedException {
        concurrencyTest(10);
    }

    @DisplayName("분산락을 사용하여 하나의 좌석을 50 개의 요청이 동시에 요청할 때, 해당 좌석에 대한 예약은 1번만 수행 된다.")
    @Test
    void thread_50() throws InterruptedException {
        concurrencyTest(50);
    }

    @DisplayName("분산락을 사용하여 하나의 좌석을 200 개의 요청이 동시에 요청할 때, 해당 좌석에 대한 예약은 1번만 수행 된다.")
    @Test
    void thread_200() throws InterruptedException {
        concurrencyTest(200);
    }

    @DisplayName("분산락을 사용하여 하나의 좌석을 1000 개의 요청이 동시에 요청할 때, 해당 좌석에 대한 예약은 1번만 수행 된다.")
    @Test
